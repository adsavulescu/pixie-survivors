...
export default class StartScreen {
    ...
    onStart(container) {
        ...
        this.mask.drawRect(0, 0, this.container.width, this.container.height);
        this.mask.endFill();
        this.container.addChild(this.mask);
        this.container.mask = this.mask;

        this.playArea = new PIXI.Container();
        this.playArea.width = 1600; // adjust as needed
        this.playArea.height = 1200; // adjust as needed
        this.container.addChild(this.playArea);
